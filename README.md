# TIPSY-N Device tree for Samsung GT-S7582/GT-S7580 (kyleprods/kylepro)
...
### Notice:
  - Apply patch *TIPSY 7.1.x patches.diff* to root directory of TIPSY-N source code before build
  
   patch -p1 < device/samsung/kylepro/TIPSY\ 7.1.x\ patches.diff
