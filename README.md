# AOS-7.1.X Device tree for Samsung GT-S7582/GT-S7580 (kyleprods/kylepro)
...
### Notice:
  - Apply patch *AOS 7.1.X patches.diff* to root directory of LOS-14.1 source code before build
